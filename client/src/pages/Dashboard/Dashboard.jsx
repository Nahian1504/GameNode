...
const Dashboard = () => {
  const { user } = useAuth();
  const { games, loading, error, pagination, fetchGames, refreshGames, clearError } = useDashboard();
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ color: "var(--color-text-secondary)", fontSize: "0.9rem" }}>
                {user?.steamId
                  ? `${pagination.total} games in your Steam library`
